...
import {bsCred, configuration, iosCapslocal} from '../helpers/config'
...
let testName = 'TC_Auto_GC_05 : To verify Gift Card functionality for Register User.'

async function giftcardmodule5(DeviceName, PlatformVersion, buildName) {
    ...
    describe(testName, function () {
        ...
        it('TC_GC_04_06_10 : To verify  INVITE SPENDER functionality.', async function () {
            ...
            await sendKey(driver, mobileNumber, giftcardDS.registredMobileNumber)
            console.log('Entered Mobile No.' + giftcardDS.registredMobileNumber)
            await driver.setImplicitWaitTimeout(2000)
        ...
        it('TC_LG_01 : To Verify the login functionality.', async function () {

            await driver.setImplicitWaitTimeout(1000)
            const mobileNo = await driver.elementByAccessibilityId(registerAccessibilityId.phone)

            await sendKey(driver, mobileNo, giftcardDS.registredMobileNumber)
            console.log('Entered Registered Mobile no : ' + giftcardDS.registredMobileNumber)

            await driver.setImplicitWaitTimeout(2000)
            const password = await driver.elementByAccessibilityId(registerAccessibilityId.password)

            await sendKey(driver, password, giftcardDS.password)
            console.log('Entered Password : ' + giftcardDS.password)
...
module.exports = giftcardmodule5