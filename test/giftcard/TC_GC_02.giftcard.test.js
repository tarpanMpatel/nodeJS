...
import {loginAccessibilityId} from '../helpers/common/androidiOSElements/login'
...
let testName = 'TC_Auto_GC_02 :To verify Gift Card functionality for KYC Completed user.'
let randommobileNumber = Math.floor(Math.random() * 9000000000) + 1000000000

async function giftcardmodule2(DeviceName, PlatformVersion, buildName) {
...
module.exports = giftcardmodule2