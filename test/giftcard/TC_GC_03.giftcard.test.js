...
let testName = 'TC_Auto_GC_03 : To verify Back icon functionality and Validation check for Gift Card functionality for KYC Completed user.'
let randommobileNumber = Math.floor(Math.random() * 9000000000) + 1000000000;

async function giftcardmodule3(DeviceName, PlatformVersion, buildName) {
    ...
    describe(testName, function () {
        ...
        it('TC_GC_018 : To verify BACK button functionality for ADD A GIFT Screen 1.', async function () {
        ...
        it('TC_GC_019 : To verify BACK button functionality for ADD A GIFT Screen 2.', async function () {
        ...
        it('TC_GC_20: To verify BACK button functionality for ADD A GIFT Screen 3.', async function () {
        ...
        it('TC_GC_21 : To verify close button functionality for ADD A GIFT Screen 3.', async function () {

            const closeButton = await driver.elementByAccessibilityId(applyCardAccessibilityId.closeButton)
        ...
        it('TC_GC_05 : To verify Name field functionality with invalid Name.', async function () {

            const firstName = await driver.elementByAccessibilityId(registerAccessibilityId.firstname)
            await sendKey(driver, firstName, giftcardDS.invalidName1)
            console.log('Entered First Name :' + giftcardDS.invalidName1)
            await driver.setImplicitWaitTimeout(3000)

            const firstNameErrorforAlphabetic = await driver.elementByXPath(registerXPath.onlyAlphanumericError)
            giftcardVM.actualfirstNameErrorforAlphabeticMSG = await firstNameErrorforAlphabetic.text()
            console.log('Actual First Name ERROR :' + giftcardVM.actualfirstNameErrorforAlphabeticMSG)
            assert.equal(giftcardVM.actualfirstNameErrorforAlphabeticMSG, giftcardVM.expectedfirstNameErrorforAlphabeticMSG, 'First Name error message verified.')

            const firstName1 = await driver.elementByAccessibilityId(registerAccessibilityId.firstname)
            await sendKey(driver, firstName1, giftcardDS.invalidName2)
            console.log('Entered First Name : ' + giftcardDS.invalidName2)
            await driver.setImplicitWaitTimeout(3000)

            const firstNameErrorforlessCharacters = await driver.elementByXPath(registerXPath.twoCharacterError)
            giftcardVM.actualfirstNameErrorforlessCharactersMSG = await firstNameErrorforlessCharacters.text()
            console.log('Actual First Name ERROR :' + giftcardVM.actualfirstNameErrorforlessCharactersMSG)
            assert.equal(giftcardVM.actualfirstNameErrorforlessCharactersMSG, giftcardVM.expectedfirstNameErrorforlessCharactersMSG, 'First Name error message verified.')

        })

        it('TC_GC_07_09 : To verify Mobile field functionality with invalid Mobile Number.', async function () {

            const mobileNumber = await driver.elementByAccessibilityId(registerAccessibilityId.phone)
            await sendKey(driver, mobileNumber, giftcardDS.invalidMobileNumber1)
            console.log('Entered Mobile number : ' + giftcardDS.invalidMobileNumber1)
            await driver.setImplicitWaitTimeout(3000)

            const mobileError = await driver.elementByXPath(giftCardXPath.mobileError)
            giftcardVM.actualmobileErrorMSG = await mobileError.text()
            console.log('Actual Mobile number ERROR :' + giftcardVM.actualmobileErrorMSG)
            assert.equal(giftcardVM.actualmobileErrorMSG, giftcardVM.expectedmobileErrorMSG, ' Mobile No error message verified.')

            const mobileNumber1 = await driver.elementByAccessibilityId(registerAccessibilityId.phone)

            await sendKey(driver, mobileNumber1, giftcardDS.invalidMobileNumber2)
            console.log('Entered Mobile number : ' + giftcardDS.invalidMobileNumber2)
            await driver.setImplicitWaitTimeout(3000)
...
module.exports = giftcardmodule3