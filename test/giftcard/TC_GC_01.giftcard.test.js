...
import {giftcardDS, registrationDS, currentTime, networkSet} from '../helpers/data'
...
let testName = 'TC_Auto_GC_01 : To verify Gift Card functionality for KYC Not_Completed user.'
let randommobileNumber = Math.floor(Math.random() * 9000000000) + 1000000000;

async function giftcardmodule1(DeviceName, PlatformVersion, buildName) {
    ...
    describe(testName, function () {
        ...
        it('TC_KYC_01 : To verify GIFT CARD button functionality for any category.', async function () {
        ...
        it('TC_KYC_41 :To Verify "Done" button functionality of ENJOY  screen.', async function () {
            ...
            if (configuration.runOs === 'android') {
                ...
                const doneButton = await driver.elementByXPath(giftCardXPath.done)
                await doneButton.click()
                console.log('Clicked on Done ')
            }
            await driver.setImplicitWaitTimeout(3000)
...
module.exports = giftcardmodule1